...
public class BookmarkEntity {
    ...
    public BookmarkEntity(long id, String heading, String content, Date date_created, Date date_last_updated, Date date_deleted, long user_id, long category_id, boolean visible) {
        ID = id;
        HEADING = heading;
        CONTENT = content;
